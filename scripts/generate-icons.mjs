...
const SVG_DIR = join(__dirname, '../shyland-dev/ui/src/assets/svg');
const OUTPUT = join(__dirname, '../shyland-dev/ui/src/lib/components/icon/icons.ts');
...
// Para adicionar/editar ícones, modifique os arquivos em shyland-dev/ui/src/assets/svg/
